...
# Multimodal imaging hackathon toolkit
This intuitive toolkit extracts relevant information across different imaging modalities (EEG and fMRI) for use without previous experience of the field - no coding or software necessary!

This repository also generates a PDF file that outlines the initial steps for analyzing unpreprocessed data.
